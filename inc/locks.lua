...
▇           ▇           ▇            ▇                    ▇
▇           ▇           ▇            ▇                    ▇
▇▇▇▇              ▇            ▇       تم برمجه وتطوير من قبل ابو جود             ▇
▇           ▇           ▇            ▇                    ▇
▇           ▇           ▇            ▇ ¦ @cgngv  ▇
▇           ▇           ▇            ▇                    ▇ ¦Dev :@sajad14p
▇▇▇▇ @sajad14p ▇▇▇                        ▇ ¦Source max BY @sajad14p
---------------------------------------------------------------------
]]
---------------Lock ------------------- 
...
if not msg.Admin then return "📡*┇*هذا الامر يخص [المطور المنشئ المدير] فقط  💥" end
if redis:get(max..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*┇*أهلا عزيزي '..msg.TheRankCmd..'\n📡*┇*الـمـيـديـا بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(max..'lock_edit'..msg.chat_id_,true)
return '🙋🏻‍♂*┇*أهلا عزيزي '..msg.TheRankCmd..'\n📡*┇*تــ✓ــم قفل الـمـيـديـا \n✓'
end
end
...
return '🙋🏻‍♂*┇*أهلا عزيزي '..msg.TheRankCmd..'\n📡*┇*الـمـيـديـا بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(max..'lock_edit'..msg.chat_id_)
return '🙋🏻‍♂*┇*أهلا عزيزي '..msg.TheRankCmd..'\n📡*┇*تــ✓ــم فتح الـمـيـديـا \n✓'
end
end
